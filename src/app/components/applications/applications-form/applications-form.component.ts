...
export class ApplicationsFormComponent implements OnInit {
  ...
  onSubmit() {
    true;//environment.consoleMessage(this.applicationsGroup, "OnSubmit fases: ");
  ...
  createRegister() {
    true;//environment.consoleMessage(this.applicationsGroup.value, "createRegister: ");
  ...
  updateRegister() {
    true;//environment.consoleMessage(this.applicationsGroup, `updateRegister para registro con id ${this.data.id}: `);
