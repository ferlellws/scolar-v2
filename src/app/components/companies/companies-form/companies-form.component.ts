...
export class CompaniesFormComponent implements OnInit {
  ...
  onSubmit() {
    true;//environment.consoleMessage(this.companiesGroup, "OnSubmit compañias: ");
  ...
  createRegister() {
    true;//environment.consoleMessage(this.companiesGroup.value, "createRegister: ");
  ...
  updateRegister() {
    true;//environment.consoleMessage(this.companiesGroup, `updateRegister para registro con id ${this.data.id}: `);
