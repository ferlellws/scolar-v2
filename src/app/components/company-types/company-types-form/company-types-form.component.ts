...
export class CompanyTypesFormComponent implements OnInit {
  ...
  onSubmit() {
    true;//environment.consoleMessage(this.companyTypesGroup, "OnSubmit tipo de compañias: ");
  ...
  createRegister() {
    true;//environment.consoleMessage(this.companyTypesGroup.value, "createRegister: ");
  ...
  updateRegister() {
    true;//environment.consoleMessage(this.companyTypesGroup, `updateRegister para registro con id ${this.data.id}: `);
