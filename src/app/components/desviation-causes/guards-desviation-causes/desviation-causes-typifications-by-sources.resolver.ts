...
export class DesviationCausesTypificationsBySourcesResolver implements Resolve<TableData> {
  constructor(
  ...
  resolve(
    ...
    state: RouterStateSnapshot): Observable<TableData> {
      return this.desviationCausesService.getDesviationCausesTypificationsBySource();
  }
}
