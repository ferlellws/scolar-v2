...
export class PrioritiesFormComponent implements OnInit {
  ...
  onSubmit() {
    true;//environment.consoleMessage(this.prioritiesGroup, "OnSubmit prioridades: ");
  ...
  createRegister() {
    true;//environment.consoleMessage(this.prioritiesGroup.value, "createRegister: ");
  ...
  updateRegister() {
    true;//environment.consoleMessage(this.prioritiesGroup, `updateRegister para registro con id ${this.data.id}: `);
