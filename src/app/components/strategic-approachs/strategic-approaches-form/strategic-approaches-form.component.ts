...
export class StrategicApproachesFormComponent implements OnInit {
  ...
  onSubmit() {
    true;//environment.consoleMessage(this.strategicApproachesGroup, "OnSubmit tipo de compañias: ");
  ...
  createRegister() {
    true;//environment.consoleMessage(this.strategicApproachesGroup.value, "createRegister: Strategic Approchaes");
  ...
  updateRegister() {
    true;//environment.consoleMessage(this.strategicApproachesGroup, `updateRegister para registro con id ${this.data.id}: `);
