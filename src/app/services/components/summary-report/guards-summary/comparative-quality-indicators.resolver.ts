...
@Injectable()
export class ComparativeQualityIndicatorsResolver implements Resolve<any> {
  ...
  resolve(
    ...
    state: RouterStateSnapshot
      ...
      return this._summaryReportService.getComparativeQualityIndicators(this.objDate);
