...
@Injectable()
export class DeliveryOpportunityIndicatorsResolver implements Resolve<any> {
  ...
  resolve(
    ...
    state: RouterStateSnapshot
      ...
      return this._summaryReportService.getDeliveryOpportunityIndicators(this.objDate);
