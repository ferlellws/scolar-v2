...
@Injectable()
export class EvolutionPerformanceIndicatorsResolver implements Resolve<any> {
  ...
  resolve(
    ...
    state: RouterStateSnapshot
      ...
      return this._summaryReportService.getEvolutionPerformanceIndicators(this.objDate);
