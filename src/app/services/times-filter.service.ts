...
export class TimesFilterService {

  private readonly API = `${environment.API}/item_record_times_filter_report`;

  emitFilter = new EventEmitter<any>();

  constructor(private http: HttpClient) { }

  getFilteredTimes(inputParams: any, filename: string = null){
      ...
      .subscribe(
        (response: any) =>{
            ...
            if (filename){
              ...
              downloadLink.setAttribute('download', "Report "+ new Date());
            }
